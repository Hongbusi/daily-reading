...
[科技爱好者周刊（第 190 期）：产品化思维](https://github.com/ruanyf/weekly/blob/master/docs/issue-190.md) <Badge type="tip" text="文章" />

[盘点掘金 2021 点赞高达 6000，收藏过万的文章](https://juejin.cn/post/7047153016771706916?utm_source=gold_browser_extension) <Badge type="tip" text="文章" />

[先做人后做事，先学规范再写代码](https://juejin.cn/post/7040855578679181342) <Badge type="tip" text="文章" />

[工作中常见的 Git 异常处理方案](https://mp.weixin.qq.com/s/2yAIp7mhEWCNvO_-u0jyGw) <Badge type="tip" text="技术" />

[CODELF（搜索 GitHub、Bitbucket、GitLab 以查找实际使用变量名称）](https://unbug.github.io/codelf) <Badge type="tip" text="工具" />
